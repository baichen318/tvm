...
def build_lenet(input_image, weight_conv1, weight_conv2, weight_fc1, weight_fc2):
    # first conv
...
def build_lenet_inf(batch_size=batch_size, target=None):
    ...
    scheme = hcl.create_scheme(
            [input_image, weight_conv1, weight_conv2, weight_fc1, weight_fc2
             ], build_lenet)
...
for i in range(10000 // batch_size):
    ...
    output_hcl = hcl.asarray(np.zeros((batch_size, 500)))
    f(input_image_hcl, weight_conv1_hcl, weight_conv2_hcl, weight_fc1_hcl, weight_fc2_hcl,
      output_hcl)
    print(output_hcl)
