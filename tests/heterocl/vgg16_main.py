...
def build_model(input_image, weight_conv1, weight_conv2, weight_conv3, weight_conv4,
    ...
    tanh8 = hlib.nn.tanh(conv5, "tanh8")
    conv6 = hlib.nn.conv2d_nchw(tanh8, weight_conv9)
    tanh9 = hlib.nn.tanh(conv6, "tanh9")
    conv7 = hlib.nn.conv2d_nchw(tanh9, weight_conv10)
    tanh10 = hlib.nn.tanh(conv7, "tanh10")
    pool4 = hlib.nn.max_pool(tanh10, kernel=(2,2), stride=(2,2), padding=[[1,1],[1,1]])
    conv5 = hlib.nn.conv2d_nchw(pool4, weight_conv11)
    tanh11 = hlib.nn.tanh(conv5, "tanh11")
    conv6 = hlib.nn.conv2d_nchw(tanh11, weight_conv12)
    tanh12 = hlib.nn.tanh(conv6, "tanh12")
    conv7 = hlib.nn.conv2d_nchw(tanh12, weight_conv13)
    tanh13 = hlib.nn.tanh(conv7, "tanh13")
    pool5 = hlib.nn.max_pool(tanh13, kernel=(2,2), stride=(2,2), padding=[[1,1],[1,1]])
    ...
    tanh14 = hlib.nn.tanh(dense1, "tanh14")
    dense2 = hlib.nn.dense(tanh14, weight_fc2)
    tanh15 = hlib.nn.tanh(dense2, "tanh15")
    dense3 = hlib.nn.dense(tanh15, weight_fc3)
...
def build_model_inf(batch_size=batch_size, target=None):
    ...
    weight_conv2 = hcl.placeholder((64, 64, 3, 3), "weight_conv2", qtype1)
    weight_conv3 = hcl.placeholder((128, 64, 3, 3), "weight_conv3", qtype1)
    weight_conv4 = hcl.placeholder((128, 128, 3, 3), "weight_conv4", qtype1)
    weight_conv5 = hcl.placeholder((256, 128, 3, 3), "weight_conv5", qtype1)
    weight_conv6 = hcl.placeholder((256, 256, 3, 3), "weight_conv6", qtype1)
    weight_conv7 = hcl.placeholder((256, 256, 3, 3), "weight_conv7", qtype1)
    weight_conv8 = hcl.placeholder((512, 256, 3, 3), "weight_conv1", qtype1)
    weight_conv9 = hcl.placeholder((512, 512, 3, 3), "weight_conv2", qtype1)
    weight_conv10 = hcl.placeholder((512, 512, 3, 3), "weight_conv3", qtype1)
    weight_conv11 = hcl.placeholder((512, 512, 3, 3), "weight_conv4", qtype1)
    ...
    weight_fc1 = hcl.placeholder((4096, 25088), "weight_fc1", qtype1)
    weight_fc2 = hcl.placeholder((4096, 4096), "weight_fc2", qtype1)
    weight_fc3 = hcl.placeholder((1000, 4096), "weight_fc3", qtype1)
    ...
    scheme.quantize([build_model.tanh1, build_model.tanh2, build_model.tanh3, build_model.tanh4,
        build_model.tanh5, build_model.tanh6, build_model.tanh7, build_model.tanh8,
        build_model.tanh9, build_model.tanh10, build_model.tanh11, build_model.tanh12,
        build_model.tanh13, build_model.tanh14], qtype2)
...
weight_conv8_hcl = hcl.asarray(weight_conv8_np, dtype=qtype1)
weight_conv9_hcl = hcl.asarray(weight_conv9_np, dtype=qtype1)
weight_conv10_hcl = hcl.asarray(weight_conv10_np, dtype=qtype1)
weight_conv11_hcl = hcl.asarray(weight_conv11_np, dtype=qtype1)
weight_conv12_hcl = hcl.asarray(weight_conv12_np, dtype=qtype1)
weight_conv13_hcl = hcl.asarray(weight_conv13_np, dtype=qtype1)
...
print(output_hcl, output_hcl.shape)
