...
def build_model(input_image, weight_conv1, weight_conv2, weight_conv3, weight_conv4, weight_conv5, weight_conv6,
                weight_conv7,weight_conv8, weight_conv9, weight_conv10, weight_conv11, weight_conv12, weight_conv13,
                weight_fc1, weight_fc2, weight_fc3):
...
def build_model_inf(batch_size=batch_size, target=None):
    ...
    scheme = hcl.create_scheme(
            [input_image, weight_conv1, weight_conv2, weight_conv3, weight_conv4, weight_conv5, weight_conv6, weight_conv7,
             weight_conv8, weight_conv9, weight_conv10, weight_conv11, weight_conv12, weight_conv13,
             weight_fc1, weight_fc2, weight_fc3], build_model)
...
output_hcl = hcl.asarray(np.zeros((batch_size, 3)))
f(input_image_hcl, weight_conv1_hcl, weight_conv2_hcl,
  weight_fc1_hcl, weight_fc2_hcl, output_hcl)
output_hcl = hcl.asarray(np.zeros((1,1000)))
f(input_image_hcl, weight_conv1_hcl, weight_conv2_hcl,weight_conv3_hcl, weight_conv4_hcl,
        weight_conv5_hcl, weight_conv6_hcl,weight_conv7_hcl, weight_conv8_hcl,
        weight_conv9_hcl, weight_conv10_hcl,weight_conv11_hcl, weight_conv12_hcl, weight_conv13_hcl,
